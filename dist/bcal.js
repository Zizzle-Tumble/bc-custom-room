...
BC.Room = (() => {
	...
	function BCAL_Room(id, data) {
		if (new.target) {
			if (data) {
				...
				setTimeout(function () { world.handleJoinRoom({ roomId: world.rooms[world.rooms.length - 1].roomId, playerCrumbs: [client.makeCrumb(world.player),crumby] }) }, 1000)
	...
	BCAL_Room.prototype.updateRoom = function (property, value) {
		BC.api.updateRoom(this.numid, property, value)
	}

	BCAL_Room.prototype.joinRoom = function () {
		BC.api.JoinRoomByIdNum(this.numid)
	}
